    ...
    <>
      ...
      <section className="relative h-screen w-full">
        <img
          src={hero_bg_1}
          alt=""
          className="absolute h-full w-full brightness-75 object-cover"
        />
        <article className="relative h-full top-20 text-center text-white">
          ...
          <h3 className="mt-96 italic">
            La plateforme créée pour les parents par les parents
          </h3>
        </article>
      </section>
      ...
      <section>
        <article className="section__grid-4 mb-16 gap-8 mx-8 mt-2 md:-mt-10">
          <button className="main-button green-bg-gradient lg:col-start-2">
            Participer aux activités
          </button>
          <button className="main-button blue-bg-gradient lg:col-start-3">
        ...
        <article className="generic-container home-section">
          ...
          <div className="section__grid-3">
            {lastPublishedLoading ? (
              ...
              lastPublishedEvents &&
              lastPublishedEvents?.eventsComplexQuery.results.map(
                (event, index) => {
                  return (
      ...
      <section>
        <article className="generic-container home-section">
          <div className="flex flex-col md:flex-row justify-between items-center mb-5">
            <h2 className="home-section__title">
              Nouvelles activités publiées
            </h2>
            <div className="flex items-center">
              <p className="md:ml-4 md:mr-10 mt-5 md:mt-0 text-xl md:text-2xl underline">
