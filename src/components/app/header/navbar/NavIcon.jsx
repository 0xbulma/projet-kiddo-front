...
import Register from '../../ModalRegisterLogin';
          ...
          <Fragment key={index}>
            {item === navIcon[3] ? (
              <Fragment>
                ...
                <ModalBackdrop composant={<Register />} open={isOpenRegister} onClose={closeModalRegister} />
              </Fragment>
            ) : item === navIcon[0] ? (
              <Fragment>
                ...
                <ModalBackdrop composant={<Search />} open={isOpenSearch} onClose={closeModalSearch} />
              </Fragment>
            ) : (
